...
<div>
        <div class="w3-modal-content w3-card-4 w3-theme" style="max-width: 600px;">
            ...
            action="<?php echo base_url('/circuito-add') ?>">
            <div class="w3-section w3-row">
                    <label><b>Circuito</b></label>
                    <input class="w3-input w3-border w3-margin-bottom" 
                    name="nombre_circuito" type="text" placeholder="Ingresar Circuito">   
            </div>
            <div class="w3-section w3-row">
                    <label><b>Codigo de Circuito</b></label>
                    <input class="w3-input w3-border w3-margin-bottom" 
                    name="codigo_circuito" type="text" placeholder="Ingresar Codigo de Circuito">   
            </div>
            <div class="w3-section w3-row">
                    <label><b>Parroquia</b></label>
                    <select name="parroquia" class="w3-select">
                        <option value="" selected disabled>Elegir Parroquia</option>
