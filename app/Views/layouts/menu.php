<!-- MENU PRINCIPAL -->
<div class="w3-container w3-bar w3-mobile w3-large w3-margin">
        <a class="w3-bar-item w3-left w3-button  w3-hover-none w3-hover-text-theme" href="<?php echo base_url('inicio') ?>"><i class="fa-solid fa-car w3-padding-small w3-xlarge"></i>VEHÍCULO GESTIÓN</a>
        <?php if(session()->get('isLoggedIn')): ?>
            <a class="w3-bar-item w3-right w3-button w3-hover-none w3-hover-text-theme" href="<?php echo base_url('/logout') ?>">Cerrar Sesión</a>
